...
roughData = readmatrix('Data_PGOX50_enzyme.csv');
data = M4_smoothData_001_09(roughData); %smoothes the data
time = roughData(7:end,1);
...
while r < 1
    P = data((1:1139),(1:10)); %extracts concentration data for the enzyme
    S = roughData(5,2:11); %extracts initial concentation data for the enzyme
...
[r2, SSE, Vo, VoModel] = M3_MM_PGOX50_001_09(data,S,time);
